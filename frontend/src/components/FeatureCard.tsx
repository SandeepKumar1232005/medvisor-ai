...
export const FeatureCard = ({ icon: Icon, title, description, color }: FeatureCardProps) => {
  ...
  return (
    <Card className="group p-6 shadow-sm hover:shadow-xl transition-all duration-300 bg-white/50 backdrop-blur-sm border-border/60 hover:border-primary/20 hover:-translate-y-1">
